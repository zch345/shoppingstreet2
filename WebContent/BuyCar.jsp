<%@ page language="java" contentType="text/html; charset=UTF-8"
    import="java.util.*,com.shoppingstreet.entity.*" pageEncoding="UTF-8"%>
    	...
    	<table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
          ...
          <c:forEach items="${sessionScope.car }" var="item" varStatus="status">
            ...
            <td align="center">
            	<div class="c_num">
                	...
                	<input type="text" value="${item.value }" name="" class="car_ipt" />  
          ...
          <tr valign="top" height="150">
          	<td colspan="6" align="right">
            	<a href="#"><img src="images/buy1.gif" /></a>&nbsp; &nbsp; <a href="ConfirmOrderServlet"><img src="images/buy2.gif" /></a>
            </td>
          </tr>
        </table>
