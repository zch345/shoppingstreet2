...
<div class="soubg">
	<div class="sou">
        ...
        <%--  
          ...
          <span class="fl">你好，请<a href="login.jsp"  style="color:#ff4e00;">登录</a>&nbsp;<a href="${ctx}/Register?action=toRegister" style="color:#ff4e00;">免费注册</a>&nbsp;&nbsp;</span>
          </c:if>
          <c:if test="${sessionScope.user!=null}">
            <span class="fl"><a href="#">${sessionScope.user.loginName}</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;</span>
          </c:if>
           <c:if test="${sessionScope.user!=null}">
...
<div class="top">
    ...
    <div class="search">
    	<form action="SearchServlet">
        	<input type="text" name="key" value="" class="s_ipt" />
